...
VAIL SUMMIT firmware is licensed under the **PolyForm Noncommercial License 1.0.0**
(see [LICENSE.md](LICENSE.md)). You may use, modify, and share it for **noncommercial**
purposes. Commercial use — including selling devices running this firmware — requires a
separate license from the copyright holder.

> Required Notice: Copyright © 2025 Brett Hollifield (KE9BOS) / Vail-CW

This project incorporates third-party open-source components under their own licenses
(MIT, Apache-2.0, BSD, **LGPL**, and **EUPL-1.2** for the morse-decoder modules). See
[THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md) for the full list and the copyleft
...
- [morse-pro](https://github.com/scp93ch/morse-pro) by Stephen C Phillips (EUPL-1.2) — basis for the morse decoder
