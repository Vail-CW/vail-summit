...
// (Downloading lives in sat_update.h as a non-blocking staged job that
// stream-splits the ~2-3MB SatNOGS JSON into per-transmitter objects and
// feeds them through satParseXmtrObject above.)
