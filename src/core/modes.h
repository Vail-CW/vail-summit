...
enum MenuMode {
    ...
    // 2-5 reserved (was MODE_HEAR_IT_MENU, MODE_HEAR_IT_TYPE_IT, MODE_HEAR_IT_CONFIGURE, MODE_HEAR_IT_START)

    // Practice (6-14)
    MODE_PRACTICE = 6,
    // 7 reserved (was MODE_KOCH_METHOD)
    // 8-14 reserved (was MODE_CW_ACADEMY_TRACK_SELECT..MODE_CW_ACADEMY_QSO_PRACTICE)
    ...
    // 70-74 reserved (was MODE_VAIL_MASTER, MODE_VAIL_MASTER_PRACTICE, MODE_VAIL_MASTER_SETTINGS, MODE_VAIL_MASTER_HISTORY, MODE_VAIL_MASTER_CHARSET)
    ...
    // Home dashboard — new root/boot screen (98)
    MODE_HOME = 98,

    // Vail CW School unified hub + practice modes (99-102)
    MODE_SCHOOL_HUB = 99,      // School landing: Learn / Daily / Copy / Send
    MODE_SCHOOL_DAILY = 100,   // Adaptive mixed copy drill over learned chars
    MODE_SCHOOL_COPY = 101,    // Open-ended listen-and-type copy practice
    MODE_SCHOOL_SEND = 102,    // Paddle send practice with live decode
    ...
    // 120-133 reserved (was LICW Training modes: MODE_LICW_CAROUSEL_SELECT..MODE_LICW_ADVERSE_COPY)
