...
#define FIRMWARE_DATE "2026-07-06"  // Update this date each time you build new firmware
...
// putBytes() struct changes layout, or a namespace must be cleared). Then add a
...
#define TONE_MENU_NAV   520   // Hz - Menu navigation beep (gentle, was 800)
#define TONE_SELECT     660   // Hz - Selection confirmation (gentle, was 1200)
