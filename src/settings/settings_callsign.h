/*
 * Callsign/Name Settings Module
 * Allows user to set their callsign or name for Vail repeater
 */

#ifndef SETTINGS_CALLSIGN_H
#define SETTINGS_CALLSIGN_H
